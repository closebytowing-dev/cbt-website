        ...
        <div className="py-4 lg:py-0">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 sm:gap-6 text-white/90 text-sm sm:text-base">
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-[#ffba42]" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            ...
            >
              ...
              <span className="font-semibold">5.0 ⭐ Perfect Rating on Google</span>
            </a>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-[#ffba42]" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
              ...
              <div className="relative bg-gradient-to-r from-gray-900 to-black rounded-xl px-3 py-2 sm:px-4 sm:py-2.5 border border-white/20 overflow-hidden">
                ...
                <div className="relative flex items-center gap-2 sm:gap-2.5">
                  ...
                  <div className="text-white">
                    {/* Mobile: Simple text */}
                    <p className="sm:hidden text-sm font-bold">24 Hours Dispatch</p>
                    {/* Desktop: Full text */}
                    <p className="hidden sm:block text-base font-bold leading-tight">24 Hour Professional Dispatch</p>
                  </div>
                </div>
              </div>
            </div>
