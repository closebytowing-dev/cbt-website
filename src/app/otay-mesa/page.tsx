...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.closebytowing.com/otay-mesa",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/otay-mesa",
  },
};
    ...
    <main className="bg-white">
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Otay Mesa",
                  "item": "https://www.closebytowing.com/otay-mesa"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/otay-mesa",
