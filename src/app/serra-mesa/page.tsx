...
// Serra Mesa ZIP codes
const SERRA_MESA_ZIP_CODES = ["92123"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.closebytowing.com/serra-mesa",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/serra-mesa",
  },
};
    ...
    <main className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-teal-500/20 border border-teal-400/30 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-teal-200 text-sm font-medium">Serving Serra Mesa 24/7 • ZIP: {SERRA_MESA_ZIP_CODES.join(", ")}</span>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-slate-900/50 relative">
                  ...
                  <div className="absolute bottom-4 left-4 bg-black/60 backdrop-blur-sm rounded-lg px-3 py-1.5">
                    <span className="text-white text-sm font-bold">ZIP: {SERRA_MESA_ZIP_CODES.join(", ")}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Serra Mesa",
                  "item": "https://www.closebytowing.com/serra-mesa"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/serra-mesa",
            ...
            address: {
              ...
              addressRegion: "CA",
              postalCode: SERRA_MESA_ZIP_CODES[0],
              addressCountry: "US",
            },
            geo: {
              "@type": "GeoCoordinates",
