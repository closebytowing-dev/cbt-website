...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.closebytowing.com/san-diego/san-carlos",
  },
};

// San Carlos specific landmarks
const LOCAL_LANDMARKS = [
  {
    name: "Lake Murray",
    description: "Lakeside recreation, trails & parking area service",
    icon: "🏞️",
  },
  {
    name: "Cowles Mountain",
    description: "Trailhead parking & hiking area assistance",
    icon: "⛰️",
  },
  {
    name: "San Carlos Shopping Center",
    description: "Vons, shops & retail parking support",
    icon: "🏪",
  },
  {
    name: "Mission Trails Regional Park",
    description: "Park access roads & visitor center service",
    icon: "🌲",
  },
  {
    name: "Navajo Community",
    description: "Residential neighborhoods & hillside homes",
    icon: "🏡",
  },
  {
    name: "Jackson Drive",
    description: "Main corridor through San Carlos residential areas",
    icon: "🛣️",
  },
];
...
// FAQ Data specific to San Carlos
const FAQ_DATA = [
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. San Carlos has many hillside properties with steep driveways, especially in the Navajo area and around Cowles Mountain. Our drivers are experienced with challenging residential access, narrow streets, and steep grades common in East County hillside communities. We have the right equipment for safe towing from difficult locations.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We provide rapid freeway response on I-8 through the San Carlos area, including the College Avenue and Jackson Drive exits. Whether you're heading to or from Mission Valley, we can reach you quickly on the freeway, shoulder, or exit ramps and safely remove your vehicle from traffic.",
  },
  {
    question: "Can you navigate the residential streets in San Carlos?",
    answer:
      "Yes, our drivers know San Carlos residential areas intimately. From the winding streets around Lake Murray to the hillside neighborhoods near Mission Trails, we're familiar with the area's layout. We regularly serve homes on narrow streets, cul-de-sacs, and challenging driveways throughout San Carlos and Navajo.",
  },
];
...
export default function SanCarlosPage() {
  return (
    <main className="bg-white">
      {/* Hero Section - Warm earth tones residential theme for San Carlos's family community character */}
      <section className="relative bg-gradient-to-br from-stone-800 via-amber-800 to-orange-900 text-white overflow-hidden">
        {/* Residential-inspired wave decoration */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-xl text-amber-100 leading-relaxed max-w-xl">
                Your neighborhood towing experts. From <span className="text-amber-300 font-semibold">Lake Murray</span> to{" "}
                <span className="text-amber-300 font-semibold">Cowles Mountain</span>, we know every street and hillside in San Carlos and respond in{" "}
                <span className="text-amber-300 font-semibold">20-40 minutes</span>.
              </p>

              {/* Quick stats */}
              <div className="mt-8 grid grid-cols-3 gap-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20">
                  <div className="text-2xl font-bold text-amber-300">20-40</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20">
                  <div className="text-2xl font-bold text-amber-300">Local</div>
                  <div className="text-sm text-amber-100">Neighborhood</div>
                </div>
              </div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-amber-500/30"
                >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              We Know <span className="text-amber-600">San Carlos</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              From Lake Murray recreation to hillside residential streets, our drivers know every corner of this established East County neighborhood.
            </p>
          </div>
      ...
      {/* About San Carlos Section */}
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
                San Carlos&apos;s <span className="text-amber-600">Trusted Towing Partner</span>
              </h2>

              <div className="mt-6 prose prose-lg text-slate-600">
                <p>
                  San Carlos is a well-established residential community nestled in the foothills of East County. With beautiful Lake Murray, proximity to Cowles Mountain and Mission Trails Regional Park, and quiet family-friendly neighborhoods, this area deserves towing service that understands the local terrain.
                </p>
                <p>
                  Whether you&apos;re stuck at Lake Murray parking area, broke down on I-8 near the College Avenue exit, need help at Cowles Mountain trailhead, or can&apos;t start your car on a steep hillside street in Navajo, CloseBy Towing provides fast, professional service with 20-40 minute response times throughout San Carlos.
                </p>
                <p>
                  Our drivers know San Carlos&apos;s unique layout—from the winding streets around Lake Murray to the hillside properties with challenging driveways. We handle everything from simple jump starts at the shopping center to complex recoveries on steep residential grades with care and professionalism.
                </p>
              </div>

              {/* Common services callout */}
              <div className="mt-8 bg-amber-100 rounded-xl p-6">
                <h3 className="font-bold text-slate-900 mb-4">Common San Carlos Calls:</h3>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  {[
                    "Lake Murray parking",
                    "Hillside driveway towing",
              ...
              <div className="space-y-3">
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Jackson Dr", "Navajo Rd", "Lake Murray Blvd", "Baltimore Dr", "Golfcrest Dr", "Cowles Mountain Blvd"].map((road) => (
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["I-8 East/West", "SR-125 South Access", "College Ave Exit"].map((freeway) => (
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              Services in <span className="text-amber-600">San Carlos</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Full range of towing and roadside services available 24/7 throughout San Carlos and Navajo.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {SERVICES.map((service) => (
              ...
              >
                ...
                <p className="text-sm text-slate-500 mt-2">Available in San Carlos</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-stone-800 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-amber-200 max-w-2xl mx-auto">
              San Carlos connects to many East County communities. We serve them all.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {NEARBY_AREAS.map((area) => (
              <Link
                key={area.slug}
                href={area.slug === "el-cajon" ? "/el-cajon" : area.slug === "la-mesa" ? "/la-mesa" : `/san-diego/${area.slug}`}
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              San Carlos Towing <span className="text-amber-600">FAQ</span>
            </h2>
          </div>
      ...
      {/* Final CTA Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-stone-800 via-amber-800 to-orange-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-5xl font-bold">
            Need a Tow in <span className="text-amber-300">San Carlos?</span>
          </h2>

          <p className="mt-6 text-xl text-amber-100 max-w-2xl mx-auto">
            Don&apos;t wait. Our neighborhood drivers are ready to help you 24/7. Fast response, fair prices, professional residential service.
          </p>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-amber-200">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>24/7 San Carlos Service</span>
            </div>
          </div>
        </div>
      </section>
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "San Carlos",
                  "item": "https://www.closebytowing.com/san-diego/san-carlos"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/san-diego/san-carlos",
            name: "CloseBy Towing - San Carlos",
            description:
