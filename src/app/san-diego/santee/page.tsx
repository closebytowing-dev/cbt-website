          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-amber-500/20 border border-amber-400/30 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-amber-200 text-sm font-medium">Serving Santee 24/7</span>
              </div>
              ...
              <p className="mt-6 text-xl text-amber-100 leading-relaxed max-w-xl">
                Your East County towing experts. From <span className="text-amber-300 font-semibold">Trolley Square</span> to{" "}
                <span className="text-amber-300 font-semibold">Santee Lakes</span>, we know every corner of Santee and respond in{" "}
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20">
                  <div className="text-2xl font-bold text-amber-300">East County</div>
                  <div className="text-sm text-amber-100">Specialists</div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-amber-900/50 relative">
                  <Image
                    ...
                    alt="Tow truck serving Santee San Diego East County near Trolley Square"
                    fill
