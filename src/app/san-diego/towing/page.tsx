        ...
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {SAN_DIEGO_AREAS.map((area) => (
              <Link
                key={area.slug}
                href={area.slug === "chula-vista" ? "/chula-vista" : area.slug === "el-cajon" ? "/el-cajon" : area.slug === "national-city" ? "/national-city" : area.slug === "spring-valley" ? "/spring-valley" : area.slug === "la-mesa" ? "/la-mesa" : `/san-diego/${area.slug}`}
