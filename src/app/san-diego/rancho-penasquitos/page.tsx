...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.closebytowing.com/san-diego/rancho-penasquitos",
  },
};
    ...
    <main className="bg-white">
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "item": "https://www.closebytowing.com/san-diego/rancho-penasquitos"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/san-diego/rancho-penasquitos",
