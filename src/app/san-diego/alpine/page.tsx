...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.closebytowing.com/san-diego/alpine",
  },
};

// Alpine specific landmarks
const LOCAL_LANDMARKS = [
  {
    name: "Viejas Casino & Resort",
    description: "Casino parking and resort area towing services",
    icon: "🎰",
  },
  {
    name: "Alpine Boulevard",
    description: "Main thoroughfare and downtown area coverage",
    icon: "🛣️",
  },
  {
    name: "Wright's Field Airport",
    description: "Private airport and aviation facility service",
    icon: "✈️",
  },
  {
    name: "Cleveland National Forest",
    description: "Forest access roads and trailhead assistance",
    icon: "🌲",
  },
  {
    name: "Viejas Outlet Center",
    description: "Shopping center and retail parking areas",
    icon: "🛍️",
  },
  {
    name: "Alpine Creek",
    description: "Rural roads and creek crossing coverage",
    icon: "🏞️",
  },
];
...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      "Yes, our drivers are experienced with Alpine's mountain terrain and rural roads. We regularly navigate the steep grades on I-8, winding roads through the Cleveland National Forest area, and elevation changes throughout the community. Our trucks are equipped for mountain towing and our team knows the safest routes.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. Alpine is a close-knit mountain community, and emergencies can happen any time. We provide 24/7 service throughout Alpine, including late nights on Alpine Boulevard, early mornings on the way to the trails, and weekends at Viejas. Whether you're a local resident or just passing through on I-8, we're here for you around the clock.",
  },
];
...
export default function AlpinePage() {
  return (
    <main className="bg-white">
      {/* Hero Section - Forest green theme for Alpine's mountain/rural character */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                Alpine
                <span className="block text-emerald-400 mt-2">Mountain Towing</span>
              </h1>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20">
                  <div className="text-2xl font-bold text-emerald-400">Rural</div>
                  <div className="text-sm text-green-100">Specialist</div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              We Know <span className="text-green-900">Alpine</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              From casino resorts to forest trails, our drivers know every corner of Alpine's mountain community.
            </p>
          </div>
      ...
      {/* About Alpine Section */}
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
                Alpine&apos;s <span className="text-green-900">Trusted Towing Service</span>
              </h2>

              <div className="mt-6 prose prose-lg text-slate-600">
                <p>
                  Alpine, a scenic mountain community in East County San Diego, requires towing services that understand rural terrain and mountain roads. Our team specializes in providing reliable towing and roadside assistance throughout this beautiful area.
                </p>
                <p>
              ...
              <div className="mt-8 bg-green-100 rounded-xl p-6">
                <h3 className="font-bold text-slate-900 mb-4">Common Alpine Services:</h3>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  {[
                    "Mountain road towing",
                    "Viejas Casino service",
                    "Rural property access",
                    "I-8 corridor emergency towing",
                    "Forest trailhead assistance",
                    "Ranch and farm towing",
                  ].map((item, i) => (
              ...
              <div className="space-y-3">
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Downtown Alpine", "Alpine Heights", "Victoria", "South Alpine", "Alpine Creek", "Alpine Oaks"].map((area) => (
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  <h4 className="font-semibold text-slate-900 text-sm mb-2">Outlying Communities:</h4>
                  <div className="flex flex-wrap gap-2">
                    {["Harbison Canyon", "Descanso", "Japatul Valley", "Alpine Highlands"].map((area) => (
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-1 text-sm text-slate-600">
                    <span>• Viejas Casino</span>
                    <span>• Wright's Field Airport</span>
                    <span>• Viejas Outlet Center</span>
                    <span>• Alpine Creek Golf</span>
                    <span>• Cleveland Nat. Forest</span>
                    <span>• Alpine Community Ctr</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              Services in <span className="text-green-900">Alpine</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Full range of towing and roadside services available 24/7 throughout Alpine's mountain community.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {SERVICES.map((service) => (
              ...
              >
                ...
                <p className="text-sm text-slate-500 mt-2">Available in Alpine</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-green-950 via-green-900 to-emerald-800 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-green-200 max-w-2xl mx-auto">
              Alpine connects to many East County San Diego communities. We serve them all.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              Alpine Towing <span className="text-green-900">FAQ</span>
            </h2>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-green-950 via-green-900 to-emerald-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-5xl font-bold">
            Need a Tow in <span className="text-emerald-400">Alpine?</span>
          </h2>

          <p className="mt-6 text-xl text-green-100 max-w-2xl mx-auto">
            Experience reliable mountain towing service. Our professional drivers are ready to assist you 24/7 with fast response and expert terrain handling.
          </p>
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Alpine",
                  "item": "https://www.closebytowing.com/san-diego/alpine"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/san-diego/alpine",
            name: "CloseBy Towing - Alpine",
            description:
            ...
            serviceType: ["Towing Service", "Roadside Assistance", "Mountain Road Towing"],
            priceRange: "$$",
