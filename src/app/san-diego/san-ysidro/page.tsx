...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.closebytowing.com/san-diego/san-ysidro",
  },
};
    ...
    <main className="bg-white">
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "San Ysidro",
                  "item": "https://www.closebytowing.com/san-diego/san-ysidro"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/san-diego/san-ysidro",
