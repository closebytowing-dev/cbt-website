...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.closebytowing.com/san-diego/sabre-springs",
  },
};

// Sabre Springs specific landmarks
const LOCAL_LANDMARKS = [
  {
    name: "Sabre Springs Community Park",
    description: "Recreation center, sports fields & community events",
    icon: "⚽",
  },
  {
    name: "Lopez Ridge Park",
    description: "Hilltop park with trails and neighborhood access",
    icon: "🏞️",
  },
  {
    name: "Sabre Springs Shopping Center",
    description: "Stater Bros, retail shops & restaurant row",
    icon: "🛒",
  },
  {
    name: "Sabre Springs Elementary",
    description: "School zone and family neighborhood access",
    icon: "🏫",
  },
  {
    name: "Willow Ridge Community",
    description: "Modern residential developments and HOAs",
    icon: "🏘️",
  },
  {
    name: "Sabre Springs Parkway",
    description: "Main thoroughfare connecting neighborhoods",
    icon: "🛣️",
  },
];
...
// FAQ Data specific to Sabre Springs
const FAQ_DATA = [
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. Sabre Springs features hillside terrain with winding residential streets and elevation changes. Our drivers are experienced with the area's topography and can safely navigate steep grades, cul-de-sacs, and hillside driveways throughout Lopez Ridge and surrounding neighborhoods.",
  },
  {
    question: "Can you handle I-15 access near Sabre Springs?",
    answer:
      "Yes, we provide rapid freeway response on I-15 near Sabre Springs. We're familiar with the Sabre Springs Parkway interchange and surrounding access roads. Whether you're on the freeway or local connecting roads, we can reach you quickly and safely remove your vehicle.",
  },
  {
    question: "What about HOA communities and gated areas?",
    answer:
      "Sabre Springs has many modern HOA communities with specific access requirements. Our drivers are professional and respectful of community standards. We can coordinate with HOAs, access gated areas appropriately, and provide discreet service that maintains your neighborhood's standards.",
  },
  {
    question: "Do you serve the shopping center and parks?",
    answer:
      "Yes, we regularly service the Sabre Springs Shopping Center on Sabre Springs Parkway, including Stater Bros and surrounding retail. We also know the Community Park, Lopez Ridge Park, and school zones. Whether you need help at a store or recreational area, we're familiar with all local destinations.",
  },
];

export default function SabreSpringsPage() {
  return (
    <main className="bg-white">
      {/* Hero Section - Fresh green/sky blue community theme */}
      <section className="relative bg-gradient-to-br from-green-700 via-teal-600 to-sky-700 text-white overflow-hidden">
        {/* Fresh wave decoration */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-xl text-teal-100 leading-relaxed max-w-xl">
                Your local towing experts in Sabre Springs&apos; vibrant community. From <span className="text-teal-300 font-semibold">Lopez Ridge</span> to{" "}
                <span className="text-teal-300 font-semibold">Willow Ridge</span>, we know every neighborhood and park in Sabre Springs and respond in{" "}
                <span className="text-teal-300 font-semibold">25-40 minutes</span>.
              </p>

              {/* Quick stats */}
              <div className="mt-8 grid grid-cols-3 gap-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20">
                  <div className="text-2xl font-bold text-teal-300">25-40</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20">
                  <div className="text-2xl font-bold text-teal-300">I-15</div>
                  <div className="text-sm text-teal-100">Freeway Access</div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              We Know <span className="text-teal-700">Sabre Springs</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              From Lopez Ridge to community parks, our drivers know every modern neighborhood and family destination in Sabre Springs.
            </p>
          </div>
      ...
      {/* About Sabre Springs Section */}
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
                Sabre Springs&apos; <span className="text-teal-700">Trusted Towing Partner</span>
              </h2>

              <div className="mt-6 prose prose-lg text-slate-600">
                <p>
                  Sabre Springs is one of North County&apos;s newer communities, featuring modern residential neighborhoods, well-maintained parks, and family-friendly amenities. From Lopez Ridge&apos;s hilltop views to the Community Park&apos;s recreation facilities, this area exemplifies contemporary suburban living.
                </p>
                <p>
                  Whether you&apos;re shopping at the Sabre Springs Center, enjoying the parks, attending school events, or navigating the hillside neighborhoods, CloseBy Towing provides reliable service throughout Sabre Springs. Our drivers understand the area&apos;s modern layout and community character.
                </p>
                <p>
                  From shopping center assistance to HOA-respectful residential towing, we provide professional service that honors your community standards. We handle everything from retail parking help to careful hillside towing with attention to Sabre Springs&apos; family-oriented atmosphere.
                </p>
              </div>

              {/* Common services callout */}
              <div className="mt-8 bg-teal-100 rounded-xl p-6">
                <h3 className="font-bold text-slate-900 mb-4">Common Sabre Springs Calls:</h3>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  {[
                    "Shopping center parking",
                    "HOA community access",
                    "Hillside neighborhood towing",
                    "Park area assistance",
                    "School zone service",
              ...
              <div className="space-y-3">
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Sabre Springs Parkway", "Camino Ruiz", "Lopez Ridge Road", "Willow Ridge Road", "Stonebridge Parkway", "Via Ronda"].map((road) => (
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["I-15 North/South", "Sabre Springs Parkway", "Rancho Penasquitos Blvd"].map((freeway) => (
                      <span key={freeway} className="bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm font-medium">
                        {freeway}
                      </span>
                    ))}
                  </div>
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-1 text-sm text-slate-600">
                    ...
                    <span>• Lopez Ridge Park</span>
                    <span>• Shopping Center</span>
                    <span>• Elementary School</span>
                    <span>• Stater Bros</span>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              Services in <span className="text-teal-700">Sabre Springs</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Full range of towing and roadside services available 24/7 throughout Sabre Springs.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {SERVICES.map((service) => (
              ...
              >
                ...
                <p className="text-sm text-slate-500 mt-2">Available in Sabre Springs</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-green-800 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-teal-200 max-w-2xl mx-auto">
              Sabre Springs connects to many North County neighborhoods. We serve them all.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              Sabre Springs Towing <span className="text-teal-700">FAQ</span>
            </h2>
          </div>
      ...
      {/* Final CTA Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-green-700 via-teal-600 to-sky-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-5xl font-bold">
            Need a Tow in <span className="text-teal-300">Sabre Springs?</span>
          </h2>

          <p className="mt-6 text-xl text-teal-100 max-w-2xl mx-auto">
            Don&apos;t wait. Our local drivers know Sabre Springs&apos; modern community inside and out. Fast response, fair prices, professional service.
          </p>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-teal-200">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>24/7 Sabre Springs Service</span>
            </div>
          </div>
        </div>
      </section>
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Sabre Springs",
                  "item": "https://www.closebytowing.com/san-diego/sabre-springs"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/san-diego/sabre-springs",
            name: "CloseBy Towing - Sabre Springs",
            description:
