        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 min-h-[85vh]">
            ...
            <div className="flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-16 lg:py-20">
              ...
              {/* Subhead */}
              <p className="text-lg sm:text-xl text-white/70 leading-relaxed max-w-lg mb-8">
              ...
              <div className="flex flex-wrap gap-2.5 mb-10">
                {[
                  ...
                  <span
                    key={pill.label}
                    className="px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-semibold flex items-center gap-2"
                  >
