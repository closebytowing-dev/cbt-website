...
const services = [
  ...
  },
  {
    ...
    tagline: "Complete Roadside Coverage",
    href: "/roadside-assistance",
    description: "On-demand roadside help for any emergency. Jump starts, tire changes, fuel delivery, lockouts, and winch-outs — no membership required.",
    image: "/services/roadside-assistance-hero.webp",
    features: ["No Membership", "5 Services in 1", "15-25 Min Response"],
    price: "From $55",
  ...
  },
  {
    ...
    tagline: "Specialized Two-Wheeler Transport",
    href: "/motorcycle-towing",
    description: "Expert motorcycle transport using soft straps and wheel chocks. Cruisers, sport bikes, Harleys — every ride gets the VIP treatment.",
    image: "/services/tow-truck-hero.webp",
    features: ["Soft-Strap Secured", "All Bike Types", "Zero Damage"],
    price: "From $85",
  ...
  },
  {
    ...
    tagline: "Big Rigs & Commercial Vehicles",
    href: "/heavyduty",
    description: "Commercial-grade towing for trucks, RVs, buses, and heavy equipment. We handle the jobs other companies turn down.",
    image: "/services/tow-truck-hero.webp",
    features: ["Trucks & RVs", "Commercial Fleet", "Heavy Equipment"],
    price: "From $150",
