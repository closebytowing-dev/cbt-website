            ...
            <div className="space-y-8">
              ...
              <p className="text-xl sm:text-2xl text-slate-600 leading-relaxed">
                ...
                <span className="inline-block mx-1 px-3 py-1 rounded-lg bg-green-50 border-2 border-green-300">
                  ...
                  <span className="text-sm text-green-700 ml-1">(save 15%)</span>
                </span>
              ...
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-green-50 border-2 border-green-300">
                  ...
                  <span className="font-black text-green-900 text-sm">100% Money Back If We Damage Your Car</span>
                </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-4">
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-green-50 border-2 border-green-200">
                  <span className="text-xl" aria-hidden="true">💵</span>
                  <div>
                    <div className="font-black text-green-900 text-sm">
                      {loading ? "$... Online" : `$${onlinePrice} Online`}
                    </div>
                    <div className="text-xs text-green-700">
                      {loading ? "Save 15%" : `$${standardPrice} standard • Save 15%`}
                    </div>
                  </div>
                </div>
