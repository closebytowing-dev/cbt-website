...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.closebytowing.com/santee",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/santee",
  },
};
    ...
    <main className="bg-white">
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Santee",
                  "item": "https://www.closebytowing.com/santee"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/santee",
