        ...
        <div className="h-full bg-gray-200/40 backdrop-blur-[2px] rounded-2xl border border-white/30 shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex flex-col justify-end px-8 md:px-10 py-6 overflow-y-auto">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-700 text-sm mt-1">Sign in to your partner account</p>
            </div>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="relative my-3">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-3 bg-white/60 text-gray-700 rounded">or continue with email</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  <span className="text-sm text-gray-900 group-hover:text-gray-700 transition">Remember me</span>
                </label>
                <button
                  type="button"
              ...
              <p className="text-center text-gray-900 text-sm">
                ...
                <Link href="/partners/signup" className="text-red-600 hover:text-red-500 font-semibold transition">
                  Sign Up
                </Link>
              </p>
            </form>
