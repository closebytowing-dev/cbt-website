  ...
  return (
    <div className="min-h-screen relative flex overflow-hidden">
      ...
      <div className="ml-auto w-full md:w-[32%] lg:w-[28%] min-h-screen relative z-10">
        <div className="h-full bg-gray-200/30 backdrop-blur-[2px] flex flex-col">
          {/* Form Content */}
            ...
            <form onSubmit={handleSignIn} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-sm text-blue-600 hover:text-blue-500 transition font-medium"
                >
                  Forgot password?
                </button>
              </div>
              ...
              <p className="text-center text-gray-900 text-sm">
                ...
                <Link href="/partners/signup" className="text-blue-600 hover:text-blue-500 font-semibold transition">
                  Sign Up
                </Link>
              </p>
              <p className="text-center text-gray-700 text-xs">
                Need help? <a href="tel:+18589999293" className="text-blue-600 hover:text-blue-500 transition">(858) 999-9293</a>
              </p>
            </form>
          </div>
        </div>
