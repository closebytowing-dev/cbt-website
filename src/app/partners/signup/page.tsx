    ...
    <div className="relative z-30 -mt-[20vh]">
      ...
      <div className="absolute inset-x-0 top-[120px] h-[250px] overflow-visible">
        ...
        >
          ...
          {/* Main wave - flowing from left to right like ocean waves */}
          <path
            d="M0,80 C180,140 360,20 540,100 C720,180 900,40 1080,120 C1260,200 1440,60 1620,140 L1620,400 L0,400 Z"
            fill="url(#waveGradient)"
          >
            <animate
              attributeName="d"
              values="M0,80 C180,140 360,20 540,100 C720,180 900,40 1080,120 C1260,200 1440,60 1620,140 L1620,400 L0,400 Z;
                      M-180,140 C0,200 180,60 360,140 C540,220 720,80 900,160 C1080,240 1260,100 1440,180 L1440,400 L-180,400 Z;
                      M0,80 C180,140 360,20 540,100 C720,180 900,40 1080,120 C1260,200 1440,60 1620,140 L1620,400 L0,400 Z"
              dur="4s"
          ...
          <path
            d="M0,80 C180,140 360,20 540,100 C720,180 900,40 1080,120 C1260,200 1440,60 1620,140 L1620,200 L0,200 Z"
            fill="url(#surfaceShimmer)"
          >
            <animate
              attributeName="d"
              values="M0,80 C180,140 360,20 540,100 C720,180 900,40 1080,120 C1260,200 1440,60 1620,140 L1620,200 L0,200 Z;
                      M-180,140 C0,200 180,60 360,140 C540,220 720,80 900,160 C1080,240 1260,100 1440,180 L1440,200 L-180,200 Z;
                      M0,80 C180,140 360,20 540,100 C720,180 900,40 1080,120 C1260,200 1440,60 1620,140 L1620,200 L0,200 Z"
              dur="4s"
              repeatCount="indefinite"
            />
          </path>
