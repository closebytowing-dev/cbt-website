...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.closebytowing.com/solana-beach",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/solana-beach",
  },
};
    ...
    <main className="bg-white">
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Solana Beach",
                  "item": "https://www.closebytowing.com/solana-beach"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/solana-beach",
