...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.closebytowing.com/downtown",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/downtown",
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/downtown",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: "Downtown",
                item: "https://www.closebytowing.com/downtown",
              },
            ],
          }),
        }}
