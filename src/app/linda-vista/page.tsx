...
// Linda Vista ZIP codes
const LINDA_VISTA_ZIP_CODES = ["92111"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.closebytowing.com/linda-vista",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/linda-vista",
  },
};
    ...
    <main className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-orange-500/20 border border-orange-400/30 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-lime-200 text-sm font-medium">Serving Linda Vista 24/7 • ZIP: {LINDA_VISTA_ZIP_CODES.join(", ")}</span>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-orange-900/50 relative">
                  ...
                  <div className="absolute bottom-4 left-4 bg-black/60 backdrop-blur-sm rounded-lg px-3 py-1.5">
                    <span className="text-white text-sm font-bold">ZIP: {LINDA_VISTA_ZIP_CODES.join(", ")}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Linda Vista",
                  "item": "https://www.closebytowing.com/linda-vista"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/linda-vista",
            ...
            address: {
              ...
              addressRegion: "CA",
              postalCode: LINDA_VISTA_ZIP_CODES[0],
              addressCountry: "US",
            },
            geo: {
              "@type": "GeoCoordinates",
