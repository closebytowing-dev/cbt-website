...
export const metadata: Metadata = {
  title: "Servicios de Grúa y Asistencia Vial en San Diego | CloseBy Towing",
  description:
    "Todos nuestros servicios en español: remolque, arranque de batería, entrega de gasolina, cambio de llanta y cerrajería de autos. Disponible 24/7 en San Diego. Llama: (858) 999-9293",
  keywords:
    "servicios grúa San Diego, remolque San Diego, arranque batería, entrega gasolina, cambio llanta, cerrajería autos, asistencia vial español, towing services español San Diego",
  openGraph: {
    title: "Servicios de Grúa y Asistencia Vial | CloseBy Towing San Diego",
    description:
      "Remolque, arranque de batería, gasolina, llantas y cerrajería. Servicio 24/7 en todo San Diego. Hablamos español.",
    url: "https://www.closebytowing.com/servicios",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/servicios",
    languages: {
      es: "https://www.closebytowing.com/servicios",
...
const SERVICIOS = [
  {
    titulo: "Remolque / Grúa",
    descripcion:
      "Grúa plataforma y remolque para autos, camionetas y SUVs. Recogemos tu vehículo y lo llevamos a donde necesites — taller, casa o cualquier destino.",
    precio: "Desde $95",
    icono: (
  ...
  },
  {
    ...
    descripcion:
      "Tu batería murió — llegamos con equipo profesional y arrancamos tu vehículo en minutos. Sin necesidad de grúa ni taller.",
    precio: "Desde $65",
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    descripcion:
      "Te quedaste sin gasolina en la carretera — te llevamos combustible directo a tu ubicación para que sigas tu camino.",
    precio: "Desde $45",
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    descripcion:
      "Llanta ponchada — llegamos a donde estés y la cambiamos por tu llanta de repuesto. Rápido, seguro y sin complicaciones.",
    precio: "Desde $75",
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    titulo: "Cerrajería de Autos",
    descripcion:
      "Llaves adentro del carro — abrimos tu vehículo sin dañarlo con herramientas profesionales. Servicio rápido y seguro.",
    precio: "Desde $65",
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    descripcion:
      "Después de un accidente, recuperamos tu vehículo con cuidado profesional. Tu seguridad y la de tu carro son nuestra prioridad.",
    precio: "Desde $125",
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const PUNTOS_CONFIANZA = [
  {
    ...
    descripcion:
      "Llegamos rápido porque estamos cerca. Nuestros operadores conocen cada calle de San Diego.",
    icono: (
  ...
  },
  {
    ...
    descripcion:
      "Te damos el precio antes de llegar. Sin cargos escondidos ni sorpresas al final.",
    icono: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    detalle: "Siempre",
    descripcion:
      "De día, de noche, fines de semana, días festivos — siempre hay alguien listo para ayudarte.",
    icono: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    detalle: "Tu Idioma",
    descripcion:
      "Nuestro equipo habla español. Comunícate con nosotros sin barreras, como en casa.",
    icono: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const PREGUNTAS = [
  {
    ...
    respuesta:
      "Nuestro tiempo promedio de respuesta es de 15 a 25 minutos en toda el área de San Diego. Dependiendo del tráfico y tu ubicación exacta, puede ser incluso más rápido.",
  },
  {
  ...
  },
  {
    ...
    respuesta:
      "Sí, estamos disponibles las 24 horas del día, los 7 días de la semana. No importa si es de madrugada, fin de semana o día festivo — siempre hay alguien listo para ayudarte.",
  },
  {
  ...
  {
    pregunta: "¿Qué hago si dejé las llaves adentro del carro?",
    respuesta:
      "Llámanos o escríbenos por WhatsApp. Nuestro cerrajero llega en minutos y abre tu vehículo sin dañarlo, usando herramientas profesionales.",
  },
];
...
export default function ServiciosPage() {
  return (
    <main className="bg-slate-950 text-white" lang="es">
      ...
      <section className="relative min-h-[75vh] flex items-center justify-start overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="CloseBy Towing — servicios de grúa y asistencia vial en San Diego"
            fill
            priority
        ...
        <div className="relative z-10 w-full mx-auto max-w-[1800px] px-4 sm:px-6 pt-32 pb-20">
          <div className="max-w-xl lg:max-w-2xl lg:ml-14">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black mb-5 leading-[0.95] text-left">
              ...
              <span className="text-amber-400">Asistencia Vial</span>
            </h1>

            <p className="text-xl sm:text-2xl font-bold text-amber-300/90 mb-6 tracking-wide text-left">
              Remolque &bull; Bater&iacute;a &bull; Gasolina &bull; Llantas &bull; Cerrajer&iacute;a
            </p>

            <p className="text-lg sm:text-xl text-slate-300 mb-10 leading-relaxed text-left">
              Todo lo que necesitas cuando tu carro te deja varado. Llegamos en 15-25 minutos a cualquier parte de San Diego &mdash; Chula Vista, National City, El Cajon, Barrio Logan y m&aacute;s.
            </p>
      ...
      {/* ══════════════════════════════════════════════════════════════
          NUESTROS SERVICIOS — Full cards with pricing
      ══════════════════════════════════════════════════════════════ */}
      <section className="bg-slate-950 py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-black text-white mb-4">
              Todos Nuestros <span className="text-amber-400">Servicios</span>
            </h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Todo lo que necesitas para salir de cualquier emergencia en la carretera. Precios transparentes, sin sorpresas.
            </p>
          </div>
            ...
            {SERVICIOS.map((servicio) => (
              ...
              >
                <div className="flex items-start justify-between mb-5">
                  <div className="w-14 h-14 bg-amber-400/10 rounded-xl flex items-center justify-center text-amber-400 group-hover:bg-amber-400/20 transition-colors">
                    {servicio.icono}
                  </div>
                  <span className="text-amber-400 font-bold text-sm bg-amber-400/10 px-3 py-1 rounded-full">
                    {servicio.precio}
                  </span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="relative aspect-[21/9] rounded-3xl overflow-hidden">
            <Image
              ...
              alt="CloseBy Towing — servicio profesional de asistencia vial en San Diego"
              fill
              className="object-cover"
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-br from-[#1e2a4a] to-[#162038] border border-slate-700/50 rounded-3xl p-10 sm:p-16 text-center shadow-2xl">
            ...
            <p className="text-slate-400 text-lg mb-6 max-w-xl mx-auto">
              No te quedes varado. Ll&aacute;manos o escr&iacute;benos por WhatsApp y llegamos en 15-25 minutos.
            </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "CloseBy Towing",
            description:
              "Servicios de grúa y asistencia vial en San Diego: remolque, arranque de batería, entrega de gasolina, cambio de llanta y cerrajería de autos. Disponible 24/7. Hablamos español.",
            url: "https://www.closebytowing.com/servicios",
            ...
            hasOfferCatalog: {
              "@type": "OfferCatalog",
              name: "Servicios de Asistencia Vial",
              itemListElement: [
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Servicio de Grúa / Remolque",
                    description: "Grúa plataforma y remolque para todo tipo de vehículo.",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Arranque de Batería",
                    description: "Servicio de arranque de batería para vehículos.",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Entrega de Gasolina",
                    description: "Entrega de combustible de emergencia a tu ubicación.",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description: "Cambio de llanta ponchada en cualquier ubicación.",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Cerrajería de Autos",
                    description: "Apertura de vehículo sin daño cuando las llaves quedan adentro.",
                  },
                },
              ],
            },
