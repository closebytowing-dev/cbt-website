        ...
        <div className="relative">
          <div className="flex gap-4 animate-[scrollLeft_40s_linear_infinite] w-max">
            {[
              ...
              <div key={i} className="flex-shrink-0 w-[510px] bg-slate-900/80 backdrop-blur-xl rounded-2xl p-7 border border-amber-500/20">
                <div className="flex items-center justify-between mb-3">
                  <span className="font-bold text-lg text-white">{r.name}</span>
                ...
                <p className="text-base text-white/70 leading-relaxed">{r.text}</p>
              </div>
            ))}
          </div>
        </div>
