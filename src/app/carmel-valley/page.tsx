...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.closebytowing.com/carmel-valley",
    type: "website",
  },
  alternates: {
    canonical: "https://www.closebytowing.com/carmel-valley",
  },
};

// Carmel Valley specific landmarks
const LOCAL_LANDMARKS = [
  {
    name: "Del Mar Highlands Town Center",
    description: "Shopping and dining complex with full parking coverage",
    icon: "🛍️",
  },
  {
    name: "One Paseo",
    description: "Mixed-use development with restaurants and retail",
    icon: "🏬",
  },
  {
    name: "Torrey Pines State Reserve",
    description: "Nature preserve with scenic overlooks and trails",
    icon: "🌲",
  },
  {
    name: "Carmel Valley Recreation Center",
    description: "Community center and sports complex coverage",
    icon: "⚽",
  },
  {
    name: "Canyon Crest Academy",
    description: "School zone and surrounding residential areas",
    icon: "🎓",
  },
  {
    name: "Pacific Highlands Ranch",
    description: "Master-planned community with modern homes",
    icon: "🏠",
  },
];
...
// FAQ Data specific to Carmel Valley
const FAQ_DATA = [
  {
    question: "How quickly can you reach Carmel Valley?",
    answer:
      "Our average response time to Carmel Valley is 15-30 minutes. We have drivers strategically positioned throughout North County San Diego, allowing us to reach Del Mar Heights, Pacific Highlands Ranch, and all Carmel Valley neighborhoods quickly.",
  },
  {
    question: "Do you service the One Paseo and Del Mar Highlands areas?",
    answer:
      "Yes, we provide full coverage for One Paseo, Del Mar Highlands Town Center, and all shopping and dining areas in Carmel Valley. Our drivers are familiar with parking structures and can assist with any vehicle situation.",
  },
  {
    question: "Can you tow luxury vehicles in Carmel Valley?",
    answer:
      "Absolutely. Carmel Valley has many luxury and high-end vehicles, and we're equipped with flatbed tow trucks specifically for safe transport of luxury, exotic, and low-clearance vehicles. Your vehicle will be handled with care.",
  },
  {
    question: "Do you provide service to Pacific Highlands Ranch?",
    answer:
      "Yes, Pacific Highlands Ranch is fully covered. We service all streets and neighborhoods in this master-planned community, including the newer developments and the commercial areas along Del Mar Heights Road.",
  },
  {
    question: "Are you available 24/7 in Carmel Valley?",
    answer:
      "Yes, we provide 24/7 towing and roadside assistance throughout Carmel Valley. Whether it's early morning, late night, or a holiday, our team is always ready to help you.",
  },
];
    ...
    <main className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-xl text-emerald-100 leading-relaxed max-w-xl">
                Professional towing for Carmel Valley&apos;s upscale community. From <span className="text-amber-300 font-semibold">Del Mar Heights</span> to{" "}
                <span className="text-amber-300 font-semibold">Pacific Highlands Ranch</span>, fast{" "}
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20">
                  ...
                  <div className="text-sm text-emerald-100">Star Rated</div>
                </div>
              </div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-emerald-950 px-8 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-amber-500/30"
                >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              We Know <span className="text-emerald-700">Carmel Valley</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              From shopping centers to nature preserves, our drivers know every corner of this beautiful community.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
                Carmel Valley&apos;s <span className="text-emerald-700">Trusted Towing</span>
              </h2>

              <div className="mt-6 prose prose-lg text-slate-600">
                <p>
                  Carmel Valley is one of San Diego&apos;s most desirable communities, known for excellent schools, beautiful homes, and convenient shopping. CloseBy Towing provides professional service that matches this community&apos;s standards.
                </p>
                <p>
                  Whether you&apos;re at One Paseo enjoying dinner, shopping at Del Mar Highlands Town Center, or driving through Pacific Highlands Ranch, our team is ready to assist with any vehicle emergency.
                </p>
                <p>
                  Our drivers understand Carmel Valley&apos;s layout—from the main arteries like Del Mar Heights Road and Carmel Valley Road to the residential streets and cul-de-sacs. We provide fast, professional service while treating your vehicle with care.
                </p>
              </div>

              <div className="mt-8 bg-emerald-100 rounded-xl p-6">
                <h3 className="font-bold text-slate-900 mb-4">Common Carmel Valley Services:</h3>
              ...
              <div className="space-y-3">
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Del Mar Heights", "Pacific Highlands Ranch", "Torrey Hills", "Carmel Creek", "Carmel Del Mar"].map((area) => (
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Del Mar Heights Rd", "Carmel Valley Rd", "El Camino Real", "Carmel Mountain Rd"].map((road) => (
                      <span key={road} className="bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-sm font-medium">
                        {road}
                      </span>
                    ))}
                  </div>
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  <h4 className="font-semibold text-slate-900 text-sm mb-2">Shopping & Dining:</h4>
                  <div className="grid grid-cols-2 gap-1 text-sm text-slate-600">
                    <span>One Paseo</span>
                    <span>Del Mar Highlands</span>
                    <span>Piazza Carmel</span>
                    <span>Carmel Creek Plaza</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              Services in <span className="text-emerald-700">Carmel Valley</span>
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Complete towing and roadside services available 24/7 throughout Carmel Valley.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {SERVICES.map((service) => (
              ...
              >
                ...
                <p className="text-sm text-slate-500 mt-2">Available in Carmel Valley</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-800 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-emerald-200 max-w-2xl mx-auto">
              Carmel Valley connects to many beautiful San Diego communities. We serve them all.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">
              Carmel Valley Towing <span className="text-emerald-700">FAQ</span>
            </h2>
          </div>
            ...
            {FAQ_DATA.map((faq, index) => (
              ...
              >
                <summary className="flex items-center justify-between p-6 cursor-pointer hover:bg-slate-50 transition-colors">
                  ...
                  <svg
                    className="w-5 h-5 text-emerald-700 flex-shrink-0 transition-transform group-open:rotate-180"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-5xl font-bold">
            Need a Tow in <span className="text-amber-400">Carmel Valley?</span>
          </h2>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`tel:${CONTACT.phoneRaw}`}
              className="inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-emerald-950 px-10 py-5 rounded-xl font-bold text-xl transition-all hover:scale-105 shadow-lg"
            >
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-emerald-200">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>24/7 Carmel Valley Service</span>
            </div>
          </div>
        </div>
      </section>
      ...
      "itemListElement": [
            ...
            },
            {
                  ...
                  "position": 3,
                  "name": "Carmel Valley",
                  "item": "https://www.closebytowing.com/carmel-valley"
            }
      ]
}) }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://www.closebytowing.com/carmel-valley",
            name: "CloseBy Towing - Carmel Valley",
            description:
